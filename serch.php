        ...
        if (isset($results) && count($results)) {
            foreach ($results as $result) {
                if (in_array($result->id, $fav_arr)) {
                    $fav_sec = $fav_sec . '
                            <div class="col-sm-4">
                    <div class="title"> <h1>' . $result->destination . '</h1></div>
                    <div id="myCarousel{{$result->id}}" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="icon-data">           
                                <i class="fa fa-heart" aria-hidden="true" onclick="makeFavourite(' . $result->id . ')"></i>  
                                <i class="fa fa-times" aria-hidden="true"></i>  
                                <i class="fa fa-trash-o" aria-hidden="true" onclick="removeFavourite(' . $result->id . ')"></i>
                            </div>
